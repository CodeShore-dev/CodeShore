...
const { techSuggestion, locationSuggestion, approveSuggestion, rejectSuggestion } =
  vi.hoisted(() => {
    const base = {
...
vi.mock('../service', () => {
  const state = {
    suggestions: [techSuggestion, locationSuggestion] as Array<
      typeof techSuggestion | typeof locationSuggestion
    >,
  };
  return {
