  ...
  <section class="mt-10">
    ...
    >
      ...
      >
        <div class="mb-4 flex items-center justify-between">
          <div class="h-4 w-8 rounded bg-[#001f2a]/8" />
          <div class="h-3 w-10 rounded bg-[#001f2a]/8" />
        </div>
        <div
          class="mb-3 h-14 w-32 rounded bg-[#001f2a]/8"
        />
        <div
          class="mb-1.5 h-3 w-full rounded bg-[#001f2a]/8"
        />
        <div
          class="mb-3 h-3 w-4/5 rounded bg-[#001f2a]/8"
        />
        <div
          class="mt-auto h-1.5 w-full rounded-full bg-[#001f2a]/8"
        />
      </div>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        <div
          class="leading-[0.95] font-black tracking-[-0.03em] text-[#003d92] tabular-nums"
          style="font-size: 3.25rem"
        >
          {{ toWanInt(benchmark.value) }}
          <span
            class="text-[1.375rem] font-black text-[#434653]"
            >萬</span
          >
        </div>
        <div
        ...
        >
          <div
            ...
            :style="{
              width: `${benchmark.position + 1}%`,
            }"
          />
          <div class="w-2 bg-[#fd7700]" />
        </div>
      </div>
    </div>
  </section>
