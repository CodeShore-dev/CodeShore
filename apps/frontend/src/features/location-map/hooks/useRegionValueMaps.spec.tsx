...
// `queries.spec.tsx` in this feature mocks `./service`. Task 18.1 removed
// the tech-view aggregation (`techCountyValues`/`useLocationTechStatsQuery`)
// from this hook (Requirement 4.1, 4.2 -- the technology view moved into
// `RegionSummaryPopup`), so `useLocationTechStatsQuery` no longer needs to be
// mocked here at all.
vi.mock('../queries', () => ({
