...
const categoryLabelMap = computed(() =>
  Object.fromEntries(
    keywordStore.tabs.map(t => [t.value, t.label]),
  ),
);
  ...
  <div class="w-full">
    ...
    <div class="mb-8">
      ...
      <div class="flex items-end justify-between gap-4">
        ...
        >
          <span
            >誰在徵人，<br class="sm:hidden" />徵什麼</span
          >
        ...
        <div class="flex shrink-0 items-center gap-3 pb-1">
          ...
          <span
            v-if="!store.loading"
            class="text-sm font-semibold text-[#434653]"
          >
    ...
    <div
      class="mb-6 flex flex-col flex-wrap gap-2 md:flex-row md:items-start"
    >
      <div class="relative flex-1">
        <span
          class="material-symbols-outlined pointer-events-none absolute top-1/2 left-3 -translate-y-1/2 text-base! text-[#434653]/50"
          >search</span
        >
        <input
        ...
        <button
          v-if="store.search"
          class="absolute top-1/2 right-3 flex -translate-y-1/2 cursor-pointer text-[#434653]/50 hover:text-[#001f2a]"
          @click="store.search = ''"
        >
      ...
      >
        <div class="flex items-start justify-between gap-2">
          <div class="flex flex-1 flex-col gap-1.5">
            <div
              class="h-6 w-36 rounded bg-[#001f2a]/[0.08]"
            />
            <div
              class="h-3 w-20 rounded bg-[#001f2a]/[0.08]"
            />
          </div>
          <div
          ...
          >
            <div
              class="h-7 w-10 rounded bg-[#001f2a]/[0.08]"
            />
            <div
              class="h-3 w-10 rounded bg-[#001f2a]/[0.08]"
            />
          </div>
        </div>
        <div class="space-y-2">
          <div
            class="h-3 w-12 rounded bg-[#001f2a]/[0.08]"
          />
          <div class="flex gap-1">
            <div
              class="h-5 w-14 rounded bg-[#001f2a]/[0.08]"
            />
            <div
              class="h-5 w-10 rounded bg-[#001f2a]/[0.08]"
            />
            <div
              class="h-5 w-16 rounded bg-[#001f2a]/[0.08]"
            />
          </div>
        </div>
      </div>
